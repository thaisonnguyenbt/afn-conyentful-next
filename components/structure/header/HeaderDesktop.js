            ...
            <div className="o-navbar__main">
                <div className="m-navbar__socialMediaList">
                    {this.state.allLanguages.map((language, i) => {
                        return <Link to={this.state.pathname ? '/' + language + this.state.pathname : language === 'en' ? '' : '/' + language} key={i} onMouseEnter={() => this.updatePathName(language)} onClick={(e) => this.props.clickCallback(e)}>
                            <div className={"flag-icon " + language }></div>
                        </Link>
                    })}
                </div>
                <div className="m-navbar__logo">
                    <Link to={this.state.currentLanguage === 'en' ? '/' : '/' + this.state.currentLanguage}>
